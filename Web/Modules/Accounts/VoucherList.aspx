<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoucherList.aspx.cs" Inherits="ERPWeb.VoucherList"
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="50%" class="Page_Heading" align="left">
                                                <h1>
                                                    List of Payment & Receipt Voucher</h1>
                                            </td>
                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy"
                                                                    PopupButtonID="imageButton2" TargetControlID="txtVoucherDate">
