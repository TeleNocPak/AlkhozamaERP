<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptVoucherSingleList.aspx.cs"
    Inherits="ERPWeb.ReceiptVoucherSingleList" MasterPageFile="~/Modules/MasterPage.Master" %>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="50%" class="Page_Heading" align="left">
                                                <h1>
                                                    List of Receipt Voucher (Cash & Bank)</h1>
                                            </td>
                                            <td align="right">
