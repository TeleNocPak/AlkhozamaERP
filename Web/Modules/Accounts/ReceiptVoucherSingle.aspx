<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiptVoucherSingle.aspx.cs"
    Inherits="ERPWeb.ReceiptVoucherSingle" MasterPageFile="~/Modules/MasterPage.Master" %>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="4" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    &nbsp;<asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="10pt" Text="Dr."></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
