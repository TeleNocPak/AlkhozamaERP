<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralVoucherList.aspx.cs"
    Inherits="ERPWeb.GeneralVoucherList" MasterPageFile="~/Modules/MasterPage.Master" %>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="50%" class="Page_Heading" align="left">
                                                <h1>
                                                    List of Journal Voucher</h1>
                                            </td>
                                            <td align="right">
                                                <asp:Button ID="btnAdd" runat="server" CssClass="btninput" Text="Add Journal Voucher"
                                        ...
                                        <tr>
                                            <td height="42" valign="middle">
                                                ...
                                                <asp:Panel ID="AgentInfoPanelDesc" runat="server">
                                                    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="border-non-table">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="30%">
                                                                <asp:TextBox ID="txtGeneralVoucherNo" runat="server" MaxLength="50" Width="142px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                Voucher Date :
                                                            </td>
                                                            <td>
                                                                ...
                                                                <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy" PopupButtonID="imageButton2"
                                                                    TargetControlID="txtGeneralVoucherDate">
                                                                </cc1:CalendarExtender>
                                                                <cc1:MaskedEditExtender ID="Maskededitextender2" runat="server" AcceptNegative="Left"
                                                                    DisplayMoney="Left" Mask="99/99/9999" MaskType="Date" TargetControlID="txtGeneralVoucherDate">
