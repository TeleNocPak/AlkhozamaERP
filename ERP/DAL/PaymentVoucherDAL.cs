...
namespace ERP.DAL
{
    public partial class PaymentVoucherDAL
    {
        public PaymentVoucherDAL()
        { }
        ...
        public DataTable GetAllMasterRecords(string Search)
        {
            ...
            SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings[ApplicationKeys.SqlConnectionString].ConnectionString);
            string WhereClause = "BookType!='JV' and BookType!='CR' and BookType!='BR'";
        ...
        public int InsertMasterRecord(PaymentVoucherDAL objPaymentVoucherDAL)
        {
            SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings[ApplicationKeys.SqlConnectionString].ConnectionString);
            int MaxCode = 0;
            try
            {
                ...
                string VoucherAutoCode = objPaymentVoucherDAL.BookType +  CommonObjects.FormatMaxCode(MaxCode);
                ...
                using (SqlCommand sqlCommand = new SqlCommand(sql, sqlConnection))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@VoucherDate", objPaymentVoucherDAL.VoucherDate);
                    sqlCommand.Parameters.AddWithValue("@BookType", objPaymentVoucherDAL.BookType);

                    sqlCommand.Parameters.AddWithValue("@ChequeNo", objPaymentVoucherDAL.ChequeNo);
                    if (string.IsNullOrWhiteSpace(objPaymentVoucherDAL.ChequeDate))
                        sqlCommand.Parameters.AddWithValue("@ChequeDate", DBNull.Value);
                    else
                        sqlCommand.Parameters.AddWithValue("@ChequeDate", CommonObjects.ConvertMMDDYYYY(objPaymentVoucherDAL.ChequeDate));

                    sqlCommand.Parameters.AddWithValue("@AutoPost", AutoPost);
                    sqlCommand.Parameters.AddWithValue("@NarrationMaster", objPaymentVoucherDAL.NarrationMaster);
        ...
        public void UpdateMasterRecord(PaymentVoucherDAL objPaymentVoucherDAL)
        {
            SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings[ApplicationKeys.SqlConnectionString].ConnectionString);
            try
            {
                ...
                using (SqlCommand sqlCommand = new SqlCommand(sql, sqlConnection))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@VoucherId", objPaymentVoucherDAL.VoucherId);
        ...
        public void InsertDetailRecord(PaymentVoucherDAL objPaymentVoucherDAL)
        {
            SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings[ApplicationKeys.SqlConnectionString].ConnectionString);
            try
            {
                ...
                {
                    sqlCommand.Parameters.AddWithValue("@VoucherId", objPaymentVoucherDAL.VoucherId);
                    sqlCommand.Parameters.AddWithValue("@AccountId", objPaymentVoucherDAL.AccountId);
                    sqlCommand.Parameters.AddWithValue("@DebitAmount", objPaymentVoucherDAL.DebitAmount);
                    sqlCommand.Parameters.AddWithValue("@CreditAmount", objPaymentVoucherDAL.CreditAmount);
                    sqlCommand.Parameters.AddWithValue("@AccountType", objPaymentVoucherDAL.AccountType);
