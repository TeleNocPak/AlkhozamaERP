    ...
    public partial class VoucherDAL
    {
        ...
        public DataTable GetAllMasterRecords(string Search)
        {
            ...
            try
            {
                ...
                //string sql = @"select * from VoucherMaster where " + WhereClause + " order by VoucherId desc";
        ...
        public int InsertMasterRecord(VoucherDAL objVoucherDAL)
        {
            SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings[ApplicationKeys.SqlConnectionString].ConnectionString);
            int MaxCode = 0;
            try
            {
                ...
                string VoucherAutoCode = objVoucherDAL.BookType + System.DateTime.Now.ToString("MM") + System.DateTime.Now.ToString("yy") + FormatMaxCode(MaxCode);

                string sql = @"INSERT INTO VoucherMaster (VoucherId,VoucherCode,VoucherDate,
                             BookType,AutoPost,NarrationMaster,BranchId,LocationId,AddedBy,AddedOn,UpdatedBy,UpdatedOn)
                             VALUES (@VoucherId,@VoucherCode,@VoucherDate,@BookType,@AutoPost,
                             @NarrationMaster,@BranchId,@LocationId,@AddedBy,@AddedOn,@UpdatedBy,@UpdatedOn)";
                ...
                using (SqlCommand sqlCommand = new SqlCommand(sql, sqlConnection))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@VoucherDate", objVoucherDAL.VoucherDate);
                    sqlCommand.Parameters.AddWithValue("@BookType", objVoucherDAL.BookType);
                    sqlCommand.Parameters.AddWithValue("@AutoPost", AutoPost);
                    sqlCommand.Parameters.AddWithValue("@NarrationMaster", objVoucherDAL.NarrationMaster);
            ...
            {
                throw new Exception(string.Format("Error occured while inserting Voucher Master: {0}", exception.Message), exception);
            }
            finally
            {
                sqlConnection.Close();
        ...
        public void UpdateMasterRecord(VoucherDAL objVoucherDAL)
        {
            SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings[ApplicationKeys.SqlConnectionString].ConnectionString);
            try
            {
                string sql = @"Update VoucherMaster SET VoucherDate = @VoucherDate, BookType = @BookType, 
                ...
                using (SqlCommand sqlCommand = new SqlCommand(sql, sqlConnection))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@BookType", objVoucherDAL.BookType);
                    sqlCommand.Parameters.AddWithValue("@NarrationMaster", objVoucherDAL.NarrationMaster);
                    sqlCommand.Parameters.AddWithValue("@VoucherId", objVoucherDAL.VoucherId);
            ...
            {
                throw new Exception(string.Format("Error occured while Updating Voucher Master: {0}", exception.Message), exception);
            }
            finally
            {
                sqlConnection.Close();
        ...
        public void InsertDetailRecord(VoucherDAL objVoucherDAL)
        {
            SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings[ApplicationKeys.SqlConnectionString].ConnectionString);
            try
            {
                ...
                {
                    sqlCommand.Parameters.AddWithValue("@VoucherId", objVoucherDAL.VoucherId);
                    sqlCommand.Parameters.AddWithValue("@AccountId", objVoucherDAL.AccountId);
                    sqlCommand.Parameters.AddWithValue("@DebitAmount", objVoucherDAL.DebitAmount);
                    sqlCommand.Parameters.AddWithValue("@CreditAmount", objVoucherDAL.CreditAmount);
                    sqlCommand.Parameters.AddWithValue("@NarrationDetail", objVoucherDAL.NarrationDetail);
            ...
            {
                throw new Exception(string.Format("Error occured while inserting Voucher Detail: {0}", exception.Message), exception);
            }
            finally
            {
                sqlConnection.Close();
        ...
        public void DeleteMasterDetailRecord(int ID)
        {
            ...
            {
                throw new Exception(string.Format("Error occured while Deleting voucher Master & Detail : {0}", exception.Message), exception);
            }
            finally
            {
                sqlConnection.Close();
